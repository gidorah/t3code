...
export const LOCAL_APP_IMAGE_REPLACEMENT_CHANNEL = "desktop:local-app-image-replacement";
export const LOCAL_APP_IMAGE_RESTART_CHANNEL = "desktop:local-app-image-restart";
export const GET_APP_BRANDING_CHANNEL = "desktop:get-app-branding";
export const GET_BUILD_COMMIT_HASH_CHANNEL = "desktop:get-build-commit-hash";
